...
def build_system_prompt(*, context: InterviewContext) -> str:
    ...
    return (
        ...
        "- Vary your acknowledgements. Do not use the same sentence pattern repeatedly.\n"
        "- React briefly to the substance of the answer before the next question.\n"
        "\n"
        ...
        "- If the candidate says stop, finish, cancel, enough, or that they do not want to continue, stop immediately.\n"
        "- Never ignore stop requests, even if the request interrupts your current question.\n"
