      ...
      <div class="space-y-10 rounded-2xl bg-white p-10 shadow-sm">
        ...
        <section>
          ...
          <ul class="list-inside list-disc space-y-2 text-gray-600">
            ...
            <li>
              Candidate profile information (resume, work history, skills)
            </li>
        ...
        <section>
          ...
          <p class="leading-relaxed text-gray-600">
            ...
            or as needed to provide our services. Candidate data (including
            video recordings) is retained for 12 months after an application is
            closed, unless you request earlier deletion. You may request
            deletion of your data at any time by contacting us at
            <a
              href="mailto:privacy@hrprescan.com"
        ...
        <section>
          ...
          <p class="leading-relaxed text-gray-600">
            ...
            cloud hosting, payment processing, and AI infrastructure) who assist
            us in operating the platform, subject to confidentiality agreements.
        ...
        <section>
          ...
          <p class="leading-relaxed text-gray-600">
            We use cookies and similar tracking technologies to analyze usage,
            remember preferences, and improve our service. You may control
            cookie settings through your browser or via our cookie consent
            banner. See our Cookie Policy for more details.
          </p>
        </section>
