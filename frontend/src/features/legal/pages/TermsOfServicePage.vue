      ...
      <div class="space-y-10 rounded-2xl bg-white p-10 shadow-sm">
        ...
        <section>
          ...
          <p class="leading-relaxed text-gray-600">
            ...
            <a
              href="mailto:security@hrprescan.com"
        ...
        <section>
          ...
          <p class="leading-relaxed text-gray-600">
            Access to premium features requires a paid subscription. Fees are
            charged in advance on a monthly or annual basis. All fees are
            non-refundable except as expressly stated in our Refund Policy.
            We reserve the right to modify pricing with 30 days' notice. Failure
        ...
        <section>
          ...
          <p class="leading-relaxed text-gray-600">
            AI-generated scores, transcripts, and assessments are provided as
        ...
        <section>
          ...
          <p class="leading-relaxed text-gray-600">
            ...
            of these Terms or for any other reason with reasonable notice. You
            may terminate your account at any time by contacting us. Upon
        ...
        <section>
          ...
          <p class="leading-relaxed text-gray-600">
            ...
            arbitration or in courts of competent jurisdiction. If any provision
            of these Terms is found invalid, the remaining provisions will
            continue in effect.
          </p>
        </section>
        ...
        <section>
          ...
          <div class="mt-3 text-gray-600">
            ...
            <p>
              Email:
              <a
                href="mailto:legal@hrprescan.com"
                class="text-blue-600 hover:underline"
