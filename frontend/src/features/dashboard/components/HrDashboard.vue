...
<template>
  ...
  <div class="mb-8 grid grid-cols-2 gap-4 lg:grid-cols-4">
    <div class="cursor-pointer rounded-xl border border-gray-100 bg-white p-5 transition-all hover:shadow-md" @click="router.push({ name: ROUTE_NAMES.VACANCY_LIST })">
      <div class="flex items-center justify-between">
        <div class="flex h-10 w-10 items-center justify-center rounded-lg bg-blue-50"><i class="pi pi-briefcase text-lg text-blue-600"></i></div>
    ...
    <div class="cursor-pointer rounded-xl border border-gray-100 bg-white p-5 transition-all hover:shadow-md" @click="router.push({ name: ROUTE_NAMES.INTERVIEW_LIST })">
      <div class="flex items-center justify-between">
        <div class="flex h-10 w-10 items-center justify-center rounded-lg bg-amber-50"><i class="pi pi-calendar text-lg text-amber-600"></i></div>
    ...
    <div class="rounded-xl border border-gray-100 bg-white p-5">
      <div class="flex items-center justify-between">
        <div class="flex h-10 w-10 items-center justify-center rounded-lg bg-emerald-50"><i class="pi pi-check-circle text-lg text-emerald-600"></i></div>
    ...
    <div class="rounded-xl border border-gray-100 bg-white p-5">
      <div class="flex items-center justify-between">
        <div class="flex h-10 w-10 items-center justify-center rounded-lg bg-violet-50"><i class="pi pi-users text-lg text-violet-600"></i></div>
  ...
  <div class="grid gap-6 lg:grid-cols-3">
    ...
    <div class="rounded-xl border border-gray-100 bg-white p-6">
      ...
      <div class="space-y-2">
        <button class="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-left text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50" @click="router.push({ name: ROUTE_NAMES.VACANCY_CREATE })">
          <div class="flex h-8 w-8 items-center justify-center rounded-lg bg-blue-50"><i class="pi pi-plus text-sm text-blue-600"></i></div>
          {{ t('dashboard.createVacancy') }}
        </button>
        <button class="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-left text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50" @click="router.push({ name: ROUTE_NAMES.VACANCY_LIST })">
        ...
        <button class="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-left text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50" @click="router.push({ name: ROUTE_NAMES.INTERVIEW_LIST })">
          <div class="flex h-8 w-8 items-center justify-center rounded-lg bg-amber-50"><i class="pi pi-video text-sm text-amber-600"></i></div>
          {{ t('nav.interviews') }}
        </button>
        <button v-if="role === 'admin'" class="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-left text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50" @click="router.push({ name: ROUTE_NAMES.TEAM_MANAGEMENT })">
          <div class="flex h-8 w-8 items-center justify-center rounded-lg bg-violet-50"><i class="pi pi-user-plus text-sm text-violet-600"></i></div>
    ...
    <div class="lg:col-span-2 rounded-xl border border-gray-100 bg-white p-6">
      <div class="mb-4 flex items-center justify-between">
        ...
        <Button :label="t('common.viewAll')" text size="small" severity="secondary" @click="router.push({ name: ROUTE_NAMES.INTERVIEW_LIST })" />
      </div>
      ...
      <div v-if="upcomingInterviews.length > 0" class="space-y-3">
        ...
        >
          ...
          <div class="text-right">
            ...
            <p class="text-xs text-gray-400">{{ iv.durationMinutes }} {{ t('dashboard.stats.min') }}</p>
          </div>
        </div>
      </div>

      <div v-else class="flex flex-col items-center py-8 text-center">
        <div class="flex h-12 w-12 items-center justify-center rounded-full bg-gray-100"><i class="pi pi-calendar text-xl text-gray-400"></i></div>
