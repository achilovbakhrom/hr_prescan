  ...
  <div class="space-y-4">
    ...
    >
      ...
      <Column :header="t('vacancies.form.companyInfo')">
        <template #body="{ data }">
          <span v-if="(data as Application).employerName || (data as Application).companyName" class="text-sm text-gray-600">
            <i class="pi pi-building mr-1 text-xs"></i>{{ (data as Application).employerName || (data as Application).companyName }}
          </span>
