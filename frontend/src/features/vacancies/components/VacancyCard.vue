  ...
  >
    <div class="flex items-start justify-between gap-3">
      ...
      <div class="flex items-center gap-2" @click.stop>
        ...
        />
        <i class="pi pi-chevron-right mt-1 hidden text-sm text-gray-300 dark:text-gray-600 sm:block"></i>
      </div>
    </div>

    <div class="mt-3 flex flex-wrap gap-2">
      <div class="flex items-center gap-1.5 rounded-lg bg-blue-50 dark:bg-blue-950 px-2 py-1 sm:px-2.5 sm:py-1.5">
      ...
      <div class="flex items-center gap-1.5 rounded-lg bg-emerald-50 dark:bg-emerald-950 px-2 py-1 sm:px-2.5 sm:py-1.5">
