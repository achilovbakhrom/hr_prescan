    ...
    <div class="mx-auto max-w-3xl px-4 py-8">
      ...
      <template v-else-if="vacancy">
        <div class="mb-6">
          ...
          <p
            v-if="vacancy.employer?.name || (vacancy as any).companyName"
            class="mt-1 text-base text-gray-500"
          >
            <i class="pi pi-building mr-1"></i
            >{{ vacancy.employer?.name || (vacancy as any).companyName }}
          </p>
        ...
        <p
          ...
          class="mb-6 text-xl font-semibold text-green-700"
        >
        ...
        <div v-if="vacancy.employer" class="mb-6 rounded-xl border border-gray-200 bg-gray-50 p-5">
          ...
          <p
            ...
            class="mt-3 whitespace-pre-line text-sm text-gray-600"
          >
