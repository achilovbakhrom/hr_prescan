...
const demoMessages: DemoMessage[] = [
  {
    role: 'ai',
    text: "👋 Hi! I'm the AI interviewer for the Senior Frontend Developer role at TechCorp. Ready to begin?",
  },
  { role: 'candidate', text: "Yes, let's go!" },
  { role: 'ai', text: 'Tell me about a complex UI challenge you solved recently.' },
  {
    role: 'candidate',
    text: 'I built a real-time collaborative editor with conflict resolution using CRDTs and Vue 3.',
  },
  {
    role: 'ai',
    text: '🎯 Impressive! Technical Skills: 9/10 • Communication: 8/10 • Advancing to interview stage.',
  },
]
...
<template>
  <section class="relative overflow-hidden px-6 py-20 sm:py-28 lg:py-36">
    ...
    <div
      class="absolute -top-32 right-1/4 h-[500px] w-[500px] rounded-full bg-blue-200/20 blur-3xl animate-float"
    ></div>
    <div
      class="absolute -bottom-32 left-1/4 h-[400px] w-[400px] rounded-full bg-indigo-200/20 blur-3xl animate-float-delayed"
    ></div>
    ...
    <div class="relative mx-auto max-w-6xl">
      <div class="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
        ...
        <div class="text-center lg:text-left">
          ...
          <!-- CTAs -->
          <div
            class="scroll-animate flex flex-col items-center gap-3 sm:flex-row lg:justify-start justify-center"
          >
            <Button
          ...
          >
            ...
            <div class="h-[320px] space-y-3 overflow-hidden p-5">
              <TransitionGroup name="chat-message" tag="div" class="space-y-3">
                ...
                >
                  <!-- AI message -->
                  <div v-if="msg.role === 'ai'" class="flex max-w-[80%] gap-2">
                    <div
                      class="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-blue-100"
                    >
