...
auth_urlpatterns = [
    ...
    path("modes/", AccountModesApi.as_view(), name="account-modes"),
    path("modes/switch/", SwitchAccountModeApi.as_view(), name="switch-account-mode"),
    path("modes/hr-space/", CreateHrSpaceApi.as_view(), name="create-hr-space"),
    path("modes/candidate-space/", CreateCandidateSpaceApi.as_view(), name="create-candidate-space"),
