    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "source_type",
                    models.CharField(
                        choices=[("hh_ru", "hh.ru"), ("hh_uz", "hh.uz"), ("telegram", "Telegram")], max_length=20
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="job_parser.parsedvacancysource",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("source", "external_id"), name="unique_parsed_vacancy_per_source"
            ),
        ),
    ]
