...
MSG_PRESCREEN_CONSENT_REQUIRED = _("You must consent to AI pre-screening to apply.")
MSG_CV_OR_LINKEDIN_NOT_BOTH = _("Provide either a CV or a LinkedIn/portfolio link, not both.")
...
MSG_NO_PRESCANNING_CRITERIA = _("Cannot publish a vacancy without prescanning evaluation criteria.")
MSG_NO_INTERVIEW_CRITERIA = _("Cannot publish a vacancy with interview enabled but no interview evaluation criteria.")
MSG_CANNOT_DELETE_LAST_CRITERIA = _("Cannot delete the last evaluation criteria for this step. Add another one first.")
...
MSG_AI_INSTRUCTIONS_FAILED = _("Failed to generate AI instructions. Please try again.")
...
MSG_NOT_CHAT_MODE = _("This session is not a prescanning chat session.")
...
MSG_CHAT_ONLY = _("Chat is only available for prescanning sessions.")
MSG_CHAT_HISTORY_ONLY = _("Chat history is only available for prescanning sessions.")
MSG_VOICE_ONLY = _("Voice messages are only available for prescanning chat sessions.")
