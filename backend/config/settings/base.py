...
REST_FRAMEWORK = {
    ...
    "PAGE_SIZE": 20,
    "EXCEPTION_HANDLER": "apps.common.exception_handlers.application_exception_handler",
...
BILLING_FREE_ACCESS_ACTIVE_USER_TARGET = int(os.environ.get("BILLING_FREE_ACCESS_ACTIVE_USER_TARGET", "500"))
...
TELEGRAM_LOGIN_WIDGET_TOKEN = TELEGRAM_CANDIDATE_BOT_TOKEN or TELEGRAM_HR_BOT_TOKEN
